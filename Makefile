...
site : _data/glossary.yml, _data/glossary-fr.yml
	rm -rf .jekyll-cache .jekyll-metadata _site
	bundle exec jekyll build

## gh-site : builds the website for GitHub pages (part of the GH Actions workflow)
gh-site : _data/glossary.yml, _data/glossary-fr.yml
	@rm -rf _gh-site
	@mkdir -p _gh-site
...
serve : _data/glossary.yml, _data/glossary-fr.yml
	rm -rf _site
...
check :
	...
	@yamllint glossary-fr.yml
	@python utils/check-glossary.py _config.yml glossary.yml
	@python utils/check-glossary.py _config.yml glossary-fr.yml
...
checkall :
	...
	@python utils/check-glossary.py -A _config.yml glossary-fr.yml
...
# Create copy of glossary file for GitHub Pages site.
_data/glossary-fr.yml : ./glossary-fr.yml
	@mkdir -p _data
	@cp $< $@
